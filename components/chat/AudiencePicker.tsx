...
const DISNEY_AUDIENCES: PickerAudience[] = [
  // UK Nationally Representative
  {
    ...
    label: 'UK Nationally Representative',
    description: 'UK adults 18+ weighted by age, gender, region and socioeconomic group',
    icon: 'users',
    agents: 10000,
    category: 'Disney — UK Population',
  },
  // Disney+ UK Subscribers
  {
    id: 'disney-uk-all-subs',
    label: 'Disney+ UK Subscribers (All)',
    description: 'All active Disney+ subscribers in the UK across all tiers',
    icon: 'tv',
    agents: 8500,
    category: 'Disney — Streaming',
  },
  {
    id: 'disney-uk-premium-subs',
    label: 'Disney+ UK Premium',
    description: 'Premium tier (ad-free) Disney+ subscribers in the UK',
    icon: 'crown',
    agents: 3400,
    category: 'Disney — Streaming',
  },
  {
    ...
    label: 'Disney+ UK Standard with Ads',
    description: 'Standard with Ads tier subscribers in the UK',
    icon: 'tv',
    agents: 3400,
    category: 'Disney — Streaming',
  },
  {
    ...
    label: 'Disney+ UK Churn Risk',
    description: 'UK subscribers showing churn indicators — low engagement or seasonal patterns',
    icon: 'trending-down',
    agents: 2200,
    category: 'Disney — Streaming',
  },
  // UK Cinema Audiences
  {
    ...
    label: 'UK Cinema-Goers',
    description: 'UK adults who attend cinema, segmented by frequency',
    icon: 'monitor-play',
    agents: 6500,
    category: 'Disney — Cinema',
  },
  {
    id: 'disney-uk-imax-premium',
    label: 'UK Premium Format Cinema',
    description: 'UK cinema-goers who regularly choose IMAX, 4DX or Dolby',
    icon: 'sparkles',
    agents: 2800,
    category: 'Disney — Cinema',
  },
  // Family & Life Stage
  {
    ...
    label: 'UK Families with Children',
    description: 'UK households with children under 16',
    icon: 'users',
    agents: 5500,
    category: 'Disney — Families',
  },
  {
    id: 'disney-uk-parents-under5',
    label: 'UK Parents of Under-5s',
    description: 'Parents of pre-school children — key for Disney Junior',
    icon: 'users',
    agents: 2800,
    category: 'Disney — Families',
  },
  {
    ...
    label: 'UK Parents of 5–11 Year Olds',
    description: 'Parents of primary-school-age children — peak Disney engagement',
    icon: 'users',
    agents: 3200,
    category: 'Disney — Families',
  },
  {
    id: 'disney-uk-tweens',
    label: 'UK Tweens & Young Teens (12–15)',
    description: 'Transitioning out of core Disney into franchise content',
    icon: 'smartphone',
    agents: 2400,
    category: 'Disney — Families',
  },
  // Age Cohorts
  {
    ...
    label: 'UK Young Adults (18–30)',
    description: 'Students, young professionals and Disney nostalgia fans',
    icon: 'zap',
    agents: 4200,
    category: 'Disney — Demographics',
  },
  {
    id: 'disney-uk-adults-31-50',
    label: 'UK Adults 31–50',
    description: 'Core subscriber demographic — parents and franchise fans',
    icon: 'user-check',
    agents: 4800,
    category: 'Disney — Demographics',
  },
  {
    ...
    label: 'UK Adults 50+',
    description: 'Grandparents, Nat Geo fans and classic Disney nostalgia viewers',
    icon: 'users',
    agents: 3600,
    category: 'Disney — Demographics',
  },
  // Franchise / Fandom
  {
    ...
    label: 'UK Marvel Fans',
    description: 'MCU fans across cinema and streaming — hardcore to lapsed',
    icon: 'sparkles',
    agents: 4800,
  ...
  },
  {
    ...
    label: 'UK Star Wars Fans',
    description: 'Star Wars fans across generations — OT to Mandalorian era',
    icon: 'sparkles',
    agents: 3600,
    category: 'Disney — Franchises',
  },
  {
    ...
    label: 'UK Pixar Fans',
    description: 'Family-skewing Pixar audience — co-viewers and child-led',
    icon: 'eye',
    agents: 3800,
    category: 'Disney — Franchises',
  },
  {
    ...
    label: 'UK Disney Animation Fans',
    description: 'Classic through modern era — princess fans, musical lovers, nostalgia',
    icon: 'sparkles',
    agents: 4200,
    category: 'Disney — Franchises',
  },
  {
    ...
    label: 'UK National Geographic Fans',
    description: 'Nature, science and documentary fans on Disney+',
    icon: 'globe',
    agents: 2600,
    category: 'Disney — Franchises',
  },
  // Behavioural / Media
  {
    ...
    label: 'UK Multi-Subscription Households',
    description: 'Households with 2+ streaming services — competitive positioning',
    icon: 'tv',
    agents: 5200,
    category: 'Disney — Behaviour',
  },
  {
    id: 'disney-uk-social-media-engaged',
    label: 'UK Social Media Engaged',
    description: 'High social media engagement — TikTok, Instagram, YouTube first',
    icon: 'smartphone',
    agents: 4500,
    category: 'Disney — Behaviour',
  },
  {
    ...
    label: 'UK Theme Park Visitors',
    description: 'Disneyland Paris and WDW visitors plus intent to visit',
    icon: 'map-pin',
    agents: 3200,
    category: 'Disney — Behaviour',
  },
  {
    ...
    label: 'UK Disney Merchandise Buyers',
    description: 'Toys, apparel, homeware and collectibles purchasers',
    icon: 'credit-card',
    agents: 3000,
    category: 'Disney — Behaviour',
  },
  // Competitive
  {
    ...
    label: 'UK Disney+ & Netflix Overlap',
    description: 'Dual subscribers — tracks primary platform loyalty and switching',
    icon: 'wifi',
    agents: 4200,
    category: 'Disney — Competitive',
  },
  {
    id: 'disney-uk-non-subscribers',
    label: 'UK Disney+ Non-Subscribers',
    description: 'Non-subscribers segmented by barrier — price, awareness, lapsed',
    icon: 'trending-down',
    agents: 3800,
    category: 'Disney — Competitive',
  },
  {
    ...
    label: 'UK Adult Drama Fans',
    description: 'Prestige drama, crime, limited series and international content fans',
    icon: 'monitor-play',
    agents: 3400,
    category: 'Disney — Streaming',
  },
